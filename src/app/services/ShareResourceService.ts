...
private MembersData: Member [];
private MembersData$: Subject<Member[]>;
...
constructor ( )  {
    ...
    this.MembersData$ = new Subject();

}

SearchMember( textUser: string ){
    const Member = this.MembersData.find((Member) => Member.Name === textUser);
    this.MembersData$.next(Member)
}
